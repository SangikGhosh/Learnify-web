            ...
            {[
              {
                ...
                description: "Monitor your course enrollments, student engagement, and revenue in real-time."
              },
              {
                icon: "https://i.pinimg.com/736x/dc/0f/ec/dc0fec8068dc99f76a01df8f4cee1b37.jpg",
                title: "Earnings dashboard",
                description: "View detailed reports of your monthly earnings and withdrawals."
              },
              {
                icon: "https://i.pinimg.com/736x/8b/7e/8c/8b7e8c2b9e1c2d7c8895a90eee5f9fb5.jpg",
                title: "Student feedback",
                description: "Read reviews and ratings to understand how students are responding to your courses."
              },
              {
                icon: "https://i.pinimg.com/736x/53/1f/04/531f04b4be56404d771b55e9563e70f2.jpg",
                title: "Marketing tools",
                description: "Access promotional tools to help grow your audience and increase enrollments."
              }
            ].map((benefit, index) => (
              <motion.div 
                key={index}
              ...
              >
                ...
                />
                <div>
                  <p className="font-semibold text-base sm:text-lg md:text-xl mb-1 sm:mb-2">{benefit.title}</p>
