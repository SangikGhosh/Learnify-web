        ...
        <div className="flex flex-col items-center order-1 lg:order-1">
          <div className="w-full px-2 lg:px-0 max-w-md text-center">
            ...
            <div className="flex justify-between w-full mb-6 sm:mb-8">
              <motion.button
                className="flex items-center px-3 py-1.5 sm:px-4 sm:py-2 border border-gray-900 rounded-lg hover:bg-gray-100 transition-colors text-sm sm:text-base cursor-pointer"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => window.location.href = "/"}
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6 mr-1 -mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M12 15a1 1 0 01-.707-.293l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L9.414 10l3.293 3.293A1 1 0 0112 15z" />
                </svg>
                Back to Home
              </motion.button>
            </div>
            ...
            <form className="space-y-4 sm:space-y-4 md:space-y-5">
              <input
                ...
                className="w-full px-4 py-3 sm:px-5 sm:py-2.5 border rounded-lg sm:rounded-xl focus:outline-none focus:ring focus:ring-black text-sm sm:text-base md:text-lg"
              />
              <input
                type="password"
              ...
              <div className="flex justify-between items-center text-xs sm:text-sm md:text-base">
                <label className="flex items-center gap-1.5 sm:gap-2 cursor-pointer z-50">
                  <input
                    type="checkbox"
            ...
            >
              ...
              <motion.div
                className="absolute z-20 w-56 sm:w-64 p-3 sm:p-4 bottom-full mb-2 bg-white rounded-lg shadow-xl border border-gray-100"
